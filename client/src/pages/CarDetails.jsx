  ...
  return car ? (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-26'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
        ...
        {/* right */}
        <div>
          {/* Add your form or sidebar content here later */}
          
          <form action="" onSubmit={handleSubmit} className='shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500'>
