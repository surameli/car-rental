...
const MyBookings = () => {
  ...
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 2xl:px-48 mt-26 text-sm max-w-7xl '>
                ...
                {/* price */}
                    <div className='md:col-span-1 flex flex-col justify-between gap-6 '>
                          <div className='text-sm text-gray-500 text-right'>
                            <p>Total Price</p>
                            <h1 className='text-2xl font-semibold text-black'>{currency}{booking.price}</h1>
